...
class Paginator {
	...
	public function links($adjacent = 3)
	{
		...
		$content = '<ul class="pagination pagination-sm no-margin pull-right">' . $this->previous('«') . $links . $this->next('»') . '</ul>';
	...
	protected function link($page, $text, $class)
	{
		...
		// return '<li> '. $query . $text .'</li>';
		return '<li><a href="'.$query.'">'.$text.'</a></li>';
	}
